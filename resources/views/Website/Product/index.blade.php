...
<body onload="myFunction()">
    <div class="container mt-5 mb-5">
        <div class="row">
            ...
            <div class="text-center card-c">Mobile</div>
            ...
            <div class="text-center card-c">Toys</div>
            @foreach($products as $product)
            ...
            <div class="text-center card-c">Charger And Cable</div>
            @foreach($products as $product)
            ...
            <div class="text-center font-weight-bold card-c">Cover And Glass</div>
            @foreach($products as $product)
            @if(($product->id)>34 )
                <div class="col-lg-4 mb-3">
                    <article class="card-custom-1">
